...
function makeDefaultOffice() {
  ...
  const furniture = [
    ...
    ...deskCluster(5, 5, { lamp: true, chairBelow: false }),
...
function makeCommandCenter() {
  ...
  const furniture = [
    ...
    // Door ops→briefing
    furn('door', 13, 3),
    // Briefing room — chairs facing whiteboards
...
function makeGamingDen() {
  ...
  const furniture = [
    ...
    ...deskCluster(1, 1, { lamp: true }),
    ...deskCluster(4, 1, { pc: true }),
    ...deskCluster(7, 1, { lamp: true, chairBelow: false }),
    furn('desk', 1, 4),
    furn('chair', 1, 6),
    furn('pc', 1, 4),
    furn('desk', 8, 4),
...
function makeLShapedOffice() {
  ...
  const furniture = [
    ...
    furn('break_couch', 14, 3),
    furn('plant', 12, 1),
    furn('plant', 16, 6),
    // Door work→meeting
    furn('door', 4, 7),
    // Meeting room
    furn('whiteboard', 7, 10),
    furn('desk', 3, 10),
    furn('chair', 6, 10),
    furn('chair', 2, 12),
    furn('plant', 9, 12),
